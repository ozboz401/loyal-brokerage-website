...
INSERT INTO public.tms_agents (id, name, email, commission_rate) VALUES (1, 'Ozan Akdemir', 'ozan@loyalbrokerage.com', 10.00), (2, 'Jane Smith', 'jane@loyalbrokerage.com', 10.00), (3, 'David Lopez', 'david@loyalbrokerage.com', 10.00) ON CONFLICT (id) DO NOTHING;

INSERT INTO public.tms_customers (id, name, contact_name, email, phone, address) VALUES (1, 'ABC Manufacturing', 'John Smith', 'john@abcmfg.com', '555-0101', '1234 Industrial Pkwy, Chicago, IL'), (2, 'Max Steel Inc', 'Sarah Johnson', 'sarah@maxsteel.com', '555-0102', '789 Steel Ave, Pittsburgh, PA'), (3, 'Global Trade Solutions', 'Mike Chen', 'mike@globaltrade.com', '555-0103', '456 Port St, Los Angeles, CA') ON CONFLICT (id) DO NOTHING;

INSERT INTO public.tms_carriers (id, name, mc_number, dot_number, contact_name, email, phone, status) VALUES (1, 'Ada Fleet LLC', 'MC123456', 'DOT789012', 'Tom Wilson', 'dispatch@adafleet.com', '555-0201', 'Active'), (2, 'Swift Carriers', 'MC234567', 'DOT890123', 'Linda Garcia', 'ops@swiftcarriers.com', '555-0202', 'Active'), (3, 'Reliable Transport', 'MC345678', 'DOT901234', 'Bob Anderson', 'dispatch@reliabletrans.com', '555-0203', 'Active') ON CONFLICT (id) DO NOTHING;
